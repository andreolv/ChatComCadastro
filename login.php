...
<div class="painel">
    <form id="loginusuario" method="post" action="controller/reqControll.php">
        ...
        <div class="row">
            <button type="submit" class="btn btn-primary col 6">Entrar</button>
            <button type="button" onclick="location.href = 'cadastro.php';" class="btn btn-success col 6">Cadastrar</button>
        </div>
    </form>
</div>
</body>
